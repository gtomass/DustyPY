...
if __name__ == '__main__':
    ...
    density = {'density type':'RDWA', 'shell': 100}

    dust = stars.Dust(DustSize={'Distribution':'MRN'},Composition = Composition, tau = 1, Sublimation = 1500, Properties='common_and_addl_grain_composite', Temperature=600, Density=density)
